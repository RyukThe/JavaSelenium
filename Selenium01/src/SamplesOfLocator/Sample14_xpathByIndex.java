...
public class Sample14_xpathByIndex 
{
	public static void main(String[] args) throws InterruptedException
	{
		...
		///enter FirstName 
		driver.findElement(By.xpath("(//input[@type='text']) [2]")).sendKeys("sdadsad");
	
		///enter LastName
		driver.findElement(By.xpath("(//input[@type='text']) [3]")).sendKeys("Muadsadadnde");
		
		///enter MobileNumber
		driver.findElement(By.xpath("(//input[@type='text']) [4]")).sendKeys("sasdaad");
